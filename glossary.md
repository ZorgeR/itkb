...
**Двухфакторная аутентификация** — метод идентификации пользователя, требующий предоставления двух разных типов данных.
...
**Фишинг** — вид мошенничества, целью которого является получение конфиденциальных данных пользователя.
